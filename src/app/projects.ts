...
export const projects: IProjects[] = [
    ...
    {name: "Portfólio", img: "./assets/imgs/Portifolio.png", descImg: "Imagem do Portifólio", desc: "Primeiro projeto pessoal feito do zero, usando o Framework Angular, layout responsivo, componentizado e dinâmico para melhor manutenção.", technologies: ["TS", "HTML", "SASS", "Angular"], urlLive: "https://joao-leao.github.io/portifolio-angular/", urlGitHub: "https://github.com/joao-leao/portifolio-angular"},
